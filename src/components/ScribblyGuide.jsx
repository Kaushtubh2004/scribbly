  ...
  return (
    <div className="bg-gray-100 py-16 px-6 md:px-20 text-black font-sans">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-12">🖋️ How to Use Scribbly</h2>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8 mb-16">
          <img src="/images/create-note.png" alt="Create note" className="w-full md:w-1/2 rounded-xl shadow-lg" />
          <div className="text-lg">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-16">
          <img src="/images/organized-notes.png" alt="Organized notes" className="w-full md:w-1/2 rounded-xl shadow-lg" />
          <div className="text-lg">
        ...
        <div className="text-center">
          <a
            href="/login"
            className="bg-black text-white px-6 py-3 rounded-xl text-lg font-medium hover:bg-gray-800 transition"
          >
            Get Started with Scribbly →
          </a>
        </div>
      </div>
    </div>
